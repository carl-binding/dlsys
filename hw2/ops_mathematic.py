...
class Reshape(TensorOp):
    ...
    def gradient(self, out_grad, node):
      ...
      ## print( f"reshape.gradient: orig_shape = {orig_shape}")
...
class BroadcastTo(TensorOp):
    ...
    def gradient(self, out_grad, node):
        ...
        grad_input = summation( out_grad, axes=tuple(axes_to_sum), keepdims=False)
...
class Summation(TensorOp):
    ...
    def compute(self, a):
      ...
      ## print( f"summation.compute: a.shape = {a.shape}")
